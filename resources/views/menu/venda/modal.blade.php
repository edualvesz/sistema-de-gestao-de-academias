    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Adicionar Mensalidade</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="content">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Digite o nome do serviço"><br>
                            <label for="exampleInputEmail1">Dia base do pagamento</label>
                            <input type="text" class="form-control" placeholder="escolher um dia do mês"><br>
