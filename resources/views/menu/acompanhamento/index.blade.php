            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a href="" class="btn btn-success" data-target="#modal-lg" data-toggle="modal">+ Iniciar Novo Acompanhamento</a>
                            <div>
                        </div>
                        @include('menu.acompanhamento.modal')
              <!--<div class="card-header">
              ...
              <div class="card-body">
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                  ...
                  <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Aluno</th>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Objetivo</th>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Ultima Atualização</th>
